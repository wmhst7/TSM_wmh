...
4 Static
"""
def return_movementData(modality):
    filename_categories = 5
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'movementData/frames'
        filename_imglist_train = 'movementData/labels/train_videofolder.txt'
        filename_imglist_val = 'movementData/labels/val_videofolder.txt'
        prefix = '{:06d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'kinetics': return_kinetics, 'movementData': return_movementData }
